...
| Oratoriano list/profile (`/manage/oratorios/oratorianos/*`) | Search, simple registration, common-profile editing, attendance summary, and history use names and localized dates. Human-equivalent name conflicts receive identity-check guidance; frequency is presented only as informative counts, without ranking, score, or classification. |
