...
5. **Done for the accepted core — add the specialized Oratório workflow.** The dedicated area consumes the current occurrence, planning, team, tracker, and ordinary Oratoriano contracts. Additional forms, Oratório Coordinator designation, and Oratoriano deletion/restoration require their own accepted frontend cycles; Missa remains a future specialized workflow and must not be invented from the Event type enum alone.
