...
The additional-form UI is currently blocked on the checked-in generated contract. The routes can create resources, but the contract does not yet provide enough read information to resume the same workflow after a reload:
