...
import { getEventAudienceLabel, getEventStatusLabel, getEventTypeLabel } from '../presentation'
  ...
  return (
    <div className="space-y-6 py-2 sm:py-4">
      ...
      <section className="space-y-4"><div><h2 className="font-heading text-xl font-bold">Presenças</h2><p className="text-sm text-muted-foreground">Pessoas com presença registrada neste evento.</p></div>
        {!canViewPresences && <ForbiddenState description="Sua conta não tem acesso à lista de presenças deste evento." />}
