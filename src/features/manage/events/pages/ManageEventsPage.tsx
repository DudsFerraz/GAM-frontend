  ...
  return (
    <div className="space-y-6 py-2 sm:py-4">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <p className="text-sm font-medium text-primary">Programação</p>
          <h1 className="font-heading text-2xl font-bold tracking-tight sm:text-3xl">
            Eventos e presenças
          </h1>
          <p className="mt-1 text-sm text-muted-foreground">
            Busque eventos, consulte detalhes e acompanhe a lista de presenças.
          </p>
        </div>
        {canCreate && (
      ...
      {query.isError &&
        (isForbiddenError(query.error) ? (
          <ForbiddenState description="Sua conta não tem acesso à busca de eventos." />
        ) : (
