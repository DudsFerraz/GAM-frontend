...
const ERROR_CODE_MESSAGES: Readonly<Record<string, string>> = {
  ...
  ORATORIANO_DELETED: 'Este cadastro foi removido e não pode receber uma nova presença. Solicite a restauração antes de continuar.',
  ORATORIANO_NAME_RESERVED: 'Já existe um cadastro ativo ou removido com esse nome. Procure a pessoa correta e, se necessário, solicite a restauração.',
